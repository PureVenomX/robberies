...
AddEventHandler("safecracking:start", function()
	...
	TriggerEvent("safecracking:loop", 6, "safe:success")
end)
...
AddEventHandler("safecracking:loop", function(difficulty,functionName)
	...
	while cracking do
		...
		DrawSprite( "MPSafeCracking", "Dial_BG", 0.75, 0.5, 0.18, 0.32, 0, 255, 255, 211, 255 )
		DrawSprite( "MPSafeCracking", "Dial", 0.75, 0.5, 0.09, 0.16, i, 255, 255, 211, 255 )
